...
<html>
    ...
    <body>
        ...
        <div class="contenidoM">
            <form name="form1" method="post" action="borrarLibro.jsp">
                <div class="contenido__libro--modificar">
                    <h3 class="contenido__libro--modificar-titulo">Eliminar Libro</h3>
                    <label class="contenido__libro--label">Titulo: </label><input class="contenido__libro--input" type="text" name="titulo" value="<%=request.getParameter("titulo")%>" readonly>
                    <label class="contenido__libro--label">Autor: </label><input class="contenido__libro--input" type="text" name="autor" value="<%=request.getParameter("autor")%>" readonly>
                    <label class="contenido__libro--label">Precio: </label><input class="contenido__libro--input" type="text" name="precio" value="<%=request.getParameter("precio")%>" readonly>
                    <label class="contenido__libro--label">Sintesis: </label> <input class="contenido__libro--input" type="text" name="sintesis" value="<%=request.getParameter("sintesis")%>" readonly>
                    <label class="contenido__libro--label">Categoria:</label>
                    <select class="contenido__libro--centro" name="idcategoria" id="idcategoria" readonly>
                    ...
                    <input class="contenido__boton boton--grid" type="submit" name="Modificar" id="Modificar" value="Eliminar">
