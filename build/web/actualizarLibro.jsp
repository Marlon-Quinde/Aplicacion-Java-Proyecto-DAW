...
<html>
    ...
    <body>
        <header>
            <h1 class="header__titulo">AmaZoom <span>Actualizar Libros</span></h1>
        </header>
        </header>
        <nav class="narbar">
        ...
        <div class="contenido">
            <% 
                             ...
                             while (rs.next()) {
                                 ...
                                 libro.setFoto(rs.getBinaryStream("foto"));
            ...
            <div class="contenido__libros">
                ...
                <form method="POST" action="ModificarLibro.jsp">
                    <p>

                        <button type="submit" class="contenido__boton">Modificar</button>
                        ...
                        <input type="hidden" name="foto" value="<%=b.getFoto()%>" >
